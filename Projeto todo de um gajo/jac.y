...
auxProgram:                                          {$$ = createNode("NULL", NULL, 0, 0);}
...
auxFieldDecl:                                        {$$ = createNode("NULL", NULL, 0, 0);}
...
auxMethodBody:                                        {$$ = createNode("NULL", NULL, 0, 0);}
...
auxFormalParams:                                      {$$ = createNode("NULL", NULL, 0, 0);}
...
auxVarDecl:                                          {$$ = createNode("NULL", NULL, 0, 0);}
...
auxStatement:                                        {$$ = createNode("NULL", NULL, 0, 0);}
...
auxMethodInvocation:                                  {$$ = createNode("NULL", NULL, 0, 0);}
